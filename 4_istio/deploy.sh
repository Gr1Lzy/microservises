...
docker build -f Dockerfile            -t service1:0.4            .
docker build -f migrations/Dockerfile -t service1-migrations:0.4 .
cd -

cd ./services/service2
docker build -f Dockerfile            -t service2:0.4            .
docker build -f migrations/Dockerfile -t service2-migrations:0.4 .
cd -

cd ./client
docker build -f Dockerfile -t client:0.4 .
cd -
